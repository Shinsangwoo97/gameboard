...
public class BoardService {
    ...
    @Transactional
    public ResponseEntity createBoard(MultipartFile imagefile, String data) throws JsonProcessingException {
        ObjectMapper objectMapper = new ObjectMapper();
        CreateBoardRequestDto requestDto = objectMapper.readValue(data,  CreateBoardRequestDto.class);
...
//        boardRepository.save(board);
    ...
    //    @Transactional
//    public ResponseEntity createBoard(CreateBoardRequestDto createBoardRequestDto, @RequestParam MultipartFile file) {
